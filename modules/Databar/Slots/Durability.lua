...
NuttUI.Databar:RegisterSlot({
    ...
    OnEnter = function(self)
        ...
        for _, info in ipairs(durabilitySlots) do
        ...
        elseif button == "RightButton" then
            ...
            if MenuUtil then
                MenuUtil.CreateContextMenu(self, function(owner, rootDescription)
                    ...
                    rootDescription:CreateRadio("None", function() return current == "None" end,
                        function() SetAutoRepair("None") end)
                    rootDescription:CreateRadio("Personal Gold", function() return current == "Player" end,
                        function() SetAutoRepair("Player") end)
                    rootDescription:CreateRadio("Guild Gold", function() return current == "Guild" end,
                        function() SetAutoRepair("Guild") end)
                end)
            else
                -- Fallback
